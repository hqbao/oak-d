    ...
    return [
        ...
        (w.topics.FRAME_INLIERS,
         w.WireFrameInliers(seq=16, ts_ns=45, ids=ids,
                            ...
                            inlier=(ids % 2 == 0))),
        (w.topics.FRAME_GYROFUSE,
         w.WireGyroFuse(seq=16, ts_ns=45, vision_rot_deg=6.2,
        ...
        (w.topics.BA_WINDOW,
         w.WireBaWindow(
             seq=22, ts_ns=55_000_000,
             kf_ids=np.arange(3, dtype=np.int64),
             kf_quat=np.array([[1.0, 0.0, 0.0, 0.0],
                               [0.92388, 0.0, 0.38268, 0.0],
                               [0.70711, 0.0, 0.70711, 0.0]], dtype=np.float64),
             kf_pos=(np.arange(9, dtype=np.float64).reshape(3, 3) * 0.5),
             ...
             obs_reproj_px=np.array([0.1, 0.5, 1.2, 2.0, 4.5],
                                    dtype=np.float32),
             ba_reproj_px=0.83,
             kf_quat_pre=np.array([[1.0, 0.0, 0.0, 0.0],
                                   [0.99619, 0.0, 0.08716, 0.0],
                                   [0.96593, 0.0, 0.25882, 0.0]],
                                  dtype=np.float64),
